...
impl RegisteredTransaction {
    ...
    pub async fn insert<'a>(database_transaction: Arc<Transaction<'a>>, registered_transaction: &InsertableRegisteredTransaction<'a>) -> Result<Self, DataError> {
        let txn = diesel::insert_into(registered_transaction::table)
            .values(registered_transaction)
            .get_result(&mut database_transaction.lock()).await?;
        Ok(txn)
    }
...
impl ExpectedWalletChargeReference {
    #[cfg_attr(feature="trace-detail", tracing::instrument)]
    pub async fn insert<'a>(transaction: Arc<Transaction<'a>>, reference: &InsertableExpectedWalletChargeReference) -> Result<Self, DataError> {
...
impl WalletCardCharge {
    #[cfg_attr(feature="trace-detail", tracing::instrument)]
    pub async fn insert<'a>(transaction: Arc<Transaction<'a>>, charge: &InsertableWalletCardCharge) -> Result<Self, DataError> {
...
impl PassthroughCardCharge {
    #[cfg_attr(feature="trace-detail", tracing::instrument)]
    pub async fn insert<'a>(transaction: Arc<Transaction<'a>>, charge: &InsertablePassthroughCardCharge) -> Result<Self, DataError> {
            let txn = diesel::insert_into(passthrough_card_charge::table)
            .values(charge)
            .get_result(&mut transaction.lock()).await?;
        Ok(txn)
    }
...
impl SuccessfulEndToEndCharge {
    #[cfg_attr(feature="trace-detail", tracing::instrument)]
    pub async fn insert<'a>(transaction: Arc<Transaction<'a>>, charge: &InsertableSuccessfulEndToEndCharge) -> Result<Self, DataError> {
