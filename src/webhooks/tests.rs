...
mod tests {
    ...
    async fn test_successful_match() {
        ...
        let wallet_returned = Wallet::find_all_for_user(&user).expect("should get wallet");
        ...
        att_returned.delete_self().expect("should delete");
        user.delete_self().expect("should delete user");
