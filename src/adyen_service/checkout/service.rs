            ...
            Some(PaymentRequest {
                ...
                payment_method: Box::new(
                    PaymentRequestPaymentMethod {
                        bank_account_number: None, bank_account_type: None, bank_location_id: None, checkout_attempt_id: None, encrypted_bank_account_number: None, encrypted_bank_location_id: None, owner_name: None, recurring_detail_reference: None,
                        ...
                        billing_address: None, delivery_address: None, personal_details: None, amazon_pay_token: None, checkout_session_id: None, apple_pay_token: None, funding_source: None, holder_name: None, issuer: None, blik_code: None, brand: None, cupsecureplus_period_smscode: None, cvc: None, encrypted_card_number: None, encrypted_expiry_month: None, encrypted_expiry_year: None, encrypted_security_code: None, expiry_month: None, expiry_year: None, network_payment_reference: None, number: None, shopper_notification_reference: None, three_ds2_sdk_version: None, first_name: None, last_name: None, shopper_email: None, telephone_number: None, google_pay_token: None, subtype: None, masterpass_transaction_id: None, order_id: None, payee_preferred: None, payer_id: None, payer_selected: None, virtual_payment_address: None, samsung_pay_token: None, iban: None, billing_sequence_number: None, visa_checkout_call_id: None, app_id: None, openid: None, click_and_collect: None,
                    }
                ),
