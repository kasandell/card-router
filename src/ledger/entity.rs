...
impl PendingPassthroughCardTransactionLedger {
    pub async fn insert<'a>(transaction: &mut Transaction<'_, '_>, ledger: &InsertablePendingPassthroughCardTransactionLedger) -> Result<Self, DataError> {
    ...
    pub async fn get<'a>(transaction: &mut Transaction<'_, '_>, id: i32) -> Result<Self, DataError> {
...
impl SettledPassthroughCardTransactionLedger {
    pub async fn insert<'a>(transaction: &mut Transaction<'_, '_>, ledger: &InsertableSettledPassthroughCardTransactionLedger) -> Result<Self, DataError> {
...
impl PendingWalletTransactionLedger {
    pub async fn insert<'a>(transaction: &mut Transaction<'_, '_>, ledger: &InsertablePendingWalletTransactionLedger) -> Result<Self, DataError> {
...
impl SettledWalletTransactionLedger {
    pub async fn insert<'a>(transaction: &mut Transaction<'_, '_>, ledger: &InsertableSettledWalletTransactionLedger) -> Result<Self, DataError> {
