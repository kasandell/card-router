...
pub trait TransactionDaoTrait {
    async fn insert_registered_transaction(self: Arc<Self>, transaction: InsertableRegisteredTransaction) -> Result<RegisteredTransaction, DataError>;
    ...
    async fn get_inner_charges_by_registered_transaction(self: Arc<Self>, registered_transaction: Uuid) -> Result<Vec<InnerChargeLedger>, DataError>;
    async fn get_successful_inner_charge_by_registered_transaction(self: Arc<Self>, registered_transaction: Uuid) -> Result<InnerChargeLedger, DataError>;
    ...
    async fn get_outer_charge_by_registered_transaction(self: Arc<Self>, registered_transaction: Uuid) -> Result<OuterChargeLedger, DataError>;
    ...
    async fn get_transaction_ledger_by_registered_transaction_id(self: Arc<Self>, id: Uuid) -> Result<TransactionLedger, DataError>;
