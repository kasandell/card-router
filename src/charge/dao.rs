...
pub trait ChargeDaoTrait {
    async fn insert_registered_transaction<'a>(self: Arc<Self>, database_transaction: Arc<Transaction<'a>>, registered_transaction: &InsertableRegisteredTransaction<'a>) -> Result<RegisteredTransaction, DataError>;
    ...
    async fn insert_expected_wallet_charge_reference<'a>(self: Arc<Self>, transaction: Arc<Transaction<'a>>,reference: &InsertableExpectedWalletChargeReference) -> Result<ExpectedWalletChargeReference, DataError>;

    async fn insert_wallet_charge<'a>(self: Arc<Self>, transaction: Arc<Transaction<'a>>, charge: &InsertableWalletCardCharge) -> Result<WalletCardCharge, DataError>;
    ...
    async fn insert_passthrough_card_charge<'a>(self: Arc<Self>, transaction: Arc<Transaction<'a>>, charge: &InsertablePassthroughCardCharge) -> Result<PassthroughCardCharge, DataError>;
    ...
    async fn insert_successful_end_to_end_charge<'a>(self: Arc<Self>, transaction: Arc<Transaction<'a>>, charge: &InsertableSuccessfulEndToEndCharge) -> Result<SuccessfulEndToEndCharge, DataError>;
...
impl ChargeDaoTrait for ChargeDao {
    ...
    async fn insert_registered_transaction<'a>(self: Arc<Self>, database_transaction: Arc<Transaction<'a>>, registered_transaction: &InsertableRegisteredTransaction<'a>) -> Result<RegisteredTransaction, DataError> {
        RegisteredTransaction::insert(database_transaction.clone(), registered_transaction).await
    }
    ...
    #[cfg_attr(feature="trace-detail", tracing::instrument(skip(self)))]
    async fn insert_wallet_charge<'a>(self: Arc<Self>, transaction: Arc<Transaction<'a>>, charge: &InsertableWalletCardCharge) -> Result<WalletCardCharge, DataError> {
        WalletCardCharge::insert(transaction.clone(), charge).await
    }
    ...
    #[cfg_attr(feature="trace-detail", tracing::instrument(skip(self)))]
    async fn insert_passthrough_card_charge<'a>(self: Arc<Self>, transaction: Arc<Transaction<'a>>, charge: &InsertablePassthroughCardCharge) -> Result<PassthroughCardCharge, DataError> {
        PassthroughCardCharge::insert(transaction.clone(), charge).await
    }
    ...
    #[cfg_attr(feature="trace-detail", tracing::instrument(skip(self)))]
    async fn insert_successful_end_to_end_charge<'a>(self: Arc<Self>, transaction: Arc<Transaction<'a>>, charge: &InsertableSuccessfulEndToEndCharge) -> Result<SuccessfulEndToEndCharge, DataError> {
        SuccessfulEndToEndCharge::insert(transaction.clone(), charge).await
    }
